...
const { extractDataFromresponse } = require('../utils/mappers');

exports.genDocs = (response, { description, docsDir = DOCS_DIR, fileType = fileTypes.JSON }) => {
  const data = extractDataFromresponse(response, description);
